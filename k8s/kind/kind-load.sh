...
docker pull harikrish147/api-gateway:1.0.0
docker pull harikrish147/product-service:1.0.0
docker pull harikrish147/order-service:1.0.0
docker pull harikrish147/inventory-service:1.0.0
docker pull harikrish147/notification-service:1.0.0
#
...
kind load docker-image -n microservices harikrish147/api-gateway:1.0.0
kind load docker-image -n microservices harikrish147/product-service:1.0.0
kind load docker-image -n microservices harikrish147/order-service:1.0.0
kind load docker-image -n microservices harikrish147/inventory-service:1.0.0
kind load docker-image -n microservices harikrish147/notification-service:1.0.0
